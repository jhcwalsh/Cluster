...
## Equal Weighted, quarterly rebalancing
...
## Risk Parity (equal risk weighted), quarterly rebalancing
...
## MVO, target return, quarterly rebalancing

```{r optimized_all,echo=FALSE}
...
## Backtesting: MVO, 84-month training/rolling period

```{r rolling_optimization,echo=FALSE,warning=FALSE}
...
rb_rolling<-optimize.portfolio.rebalancing(R=returns,portfolio=portfolio.rb,
                            optimize_method = "DEoptim",rebalance_on = "years",
                            training_period = 84,rolling_period= 84,trace=TRUE)
...
```{r cluster_MVO_level_1,echo=FALSE}
#Create states
...
```{r cluster_backtest, echo=FALSE,warning=FALSE}
